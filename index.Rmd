...
```
That created a dataframe with only Seton Hall's stats, while I'll eventually create one for Maryland, as well. This is to compare both teams' stats side-by-side.
```{r}
ggplot() + 
